...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../../.designer/backup/icons8-mail-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.link_input.setStyleSheet("font: 57 10pt \"Roboto Mono Medium for Powerline\";")
...
"color: rgb(229, 165, 10);")
        ...
        self.extracting.setStyleSheet("font: 57 11pt \"Roboto Mono Medium for Powerline\";\n"
...
"color: rgb(255, 255, 255);")
        self.link_extract_btn.setCheckable(False)
        ...
        self.save_to_file_btn.setStyleSheet("background-color: rgb(98, 160, 234);")
        self.save_to_file_btn.setObjectName("save_to_file_btn")
        self.horizontalLayout_11.addWidget(self.save_to_file_btn)
        ...
        self.mail_type = QtWidgets.QComboBox(self.frame_19)
        self.mail_type.setObjectName("mail_type")
        self.mail_type.addItem("")
        self.mail_type.addItem("")
        self.mail_type.addItem("")
        self.mail_type.addItem("")
        self.mail_type.addItem("")
        ...
        self.mail_type.addItem("")
        self.mail_type.addItem("")
        self.horizontalLayout_8.addWidget(self.mail_type)
        ...
        self.extracted_emails.setStyleSheet("font: 57 11pt \"Roboto Mono Medium for Powerline\";\n"
"")
        ...
        self.process_output.setStyleSheet("color: rgb(87, 227, 137);\n"
"font: 57 10pt \"Roboto Mono Medium for Powerline\";")
        ...
        self.Text_to_extract = QtWidgets.QPlainTextEdit(self.frame_7)
        ...
        self.text_mail_type = QtWidgets.QComboBox(self.frame_5)
        self.text_mail_type.setObjectName("text_mail_type")
        self.text_mail_type.addItem("")
        self.text_mail_type.addItem("")
        self.text_mail_type.addItem("")
        self.text_mail_type.addItem("")
        self.text_mail_type.addItem("")
        ...
        self.text_mail_type.addItem("")
        self.text_mail_type.addItem("")
        self.horizontalLayout_10.addWidget(self.text_mail_type)
        ...
        self.text_email_extract.setStyleSheet("font: 57 10pt \"Roboto Mono Medium for Powerline\";")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.save_to_file_btn.setText(_translate("mainWindow", "Save"))
        self.label_4.setText(_translate("mainWindow", "Email Type:"))
        self.mail_type.setItemText(0, _translate("mainWindow", "All"))
        self.mail_type.setItemText(1, _translate("mainWindow", "gmail"))
        self.mail_type.setItemText(2, _translate("mainWindow", "hotmail"))
        self.mail_type.setItemText(3, _translate("mainWindow", "yahoo"))
        self.mail_type.setItemText(4, _translate("mainWindow", "att"))
        self.mail_type.setItemText(5, _translate("mainWindow", "rocketmail"))
        self.mail_type.setItemText(6, _translate("mainWindow", "sbcglobal"))
        self.mail_type.setItemText(7, _translate("mainWindow", "outlook"))
        self.mail_type.setItemText(8, _translate("mainWindow", "live"))
        self.mail_type.setItemText(9, _translate("mainWindow", "msn"))
        self.mail_type.setItemText(10, _translate("mainWindow", "aol"))
        self.mail_type.setItemText(11, _translate("mainWindow", "wanadoo"))
        self.mail_type.setItemText(12, _translate("mainWindow", "orange"))
        self.mail_type.setItemText(13, _translate("mainWindow", "rediffmail"))
        self.mail_type.setItemText(14, _translate("mainWindow", "free"))
        self.mail_type.setItemText(15, _translate("mainWindow", "gmx"))
        self.mail_type.setItemText(16, _translate("mainWindow", "blueyonder"))
        self.mail_type.setItemText(17, _translate("mainWindow", "skynet"))
        self.mail_type.setItemText(18, _translate("mainWindow", "comcast"))
        self.mail_type.setItemText(19, _translate("mainWindow", "laposte"))
        self.mail_type.setItemText(20, _translate("mainWindow", "bellsouth"))
        ...
        self.text_mail_type.setItemText(0, _translate("mainWindow", "All"))
        self.text_mail_type.setItemText(1, _translate("mainWindow", "gmail"))
        self.text_mail_type.setItemText(2, _translate("mainWindow", "hotmail"))
        self.text_mail_type.setItemText(3, _translate("mainWindow", "yahoo"))
        self.text_mail_type.setItemText(4, _translate("mainWindow", "att"))
        self.text_mail_type.setItemText(5, _translate("mainWindow", "rocketmail"))
        self.text_mail_type.setItemText(6, _translate("mainWindow", "sbcglobal"))
        self.text_mail_type.setItemText(7, _translate("mainWindow", "outlook"))
        self.text_mail_type.setItemText(8, _translate("mainWindow", "live"))
        self.text_mail_type.setItemText(9, _translate("mainWindow", "msn"))
        self.text_mail_type.setItemText(10, _translate("mainWindow", "aol"))
        self.text_mail_type.setItemText(11, _translate("mainWindow", "wanadoo"))
        self.text_mail_type.setItemText(12, _translate("mainWindow", "orange"))
        self.text_mail_type.setItemText(13, _translate("mainWindow", "rediffmail"))
        self.text_mail_type.setItemText(14, _translate("mainWindow", "free"))
        self.text_mail_type.setItemText(15, _translate("mainWindow", "gmx"))
        self.text_mail_type.setItemText(16, _translate("mainWindow", "blueyonder"))
        self.text_mail_type.setItemText(17, _translate("mainWindow", "skynet"))
        self.text_mail_type.setItemText(18, _translate("mainWindow", "comcast"))
        self.text_mail_type.setItemText(19, _translate("mainWindow", "laposte"))
        self.text_mail_type.setItemText(20, _translate("mainWindow", "bellsouth"))
